window.MARCO_INITIAL_DATA={
  ...
  installation:{generation:'v240-clean',appVersion:'2.8.8',createdAt:new Date().toISOString()},
  ...
  dataByProfile:{marco:{
    ...
    audit:[{id:'initial',date:new Date().toISOString(),action:'Base criada',detail:'Instalação limpa v2.8.8 criada. Dados, Drive e integração começam sem herdar referências antigas.'}]
  }}
};
