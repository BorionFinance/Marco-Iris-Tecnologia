window.MARCO_INITIAL_DATA={
  ...
  installation:{generation:'v240-clean',appVersion:window.MARCO_APP_VERSION||'2.8.14',createdAt:new Date().toISOString()},
  ...
  dataByProfile:{marco:{
    ...
    audit:[{id:'initial',date:new Date().toISOString(),action:'Base criada',detail:'Instalação limpa v2.8.14 criada. Dados, Drive e integração começam sem herdar referências antigas.'}]
  }}
};
